...
const TenantPayment = () => {
  ...
  return (
    <>
      <div className=" w-full h-full bg-white px-5 overflow-clip  ">
        ...
        <div className="lg:flex-row lg:gap-2 w-full flex flex-col ">
          <div className="lg:w-1/2 lg:h-auto ">
            ...
            <div className='flex justify-evenly pb-3 bg-white rounded-md text-primary-color '>
              <div className="form-control">
                <label className="label cursor-pointer">
                  <span className="label-text text-primary-color">E-wallet</span>
                  <input
                    type="radio"
                    name="radio-10"
                    className="radio checked:checked:bg-light-gray ml-5"
                    id="ewallet"
                    value="ewallet"
              ...
              <div className="form-control">
                <label className="label cursor-pointer">
                  <span className="label-text text-primary-color">Cash</span>
                  <input
                    type="radio"
                    name="radio-10"
                    className="radio checked:bg-dark-gray ml-5  "
                    id="cash"
                    value="cash"
            ...
            <div>
                  ...
                  <div className="p-5 lg:h-auto bg-white shadow-md shadow-dark-gray">
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        autoComplete="off"
                        className="mt-1 px-2 py-1 border bg-white border-dark-gray rounded-md w-full"
                      />
              ...
              {selectedOption === 'cash' && (
                <div className=" py-7 px-5 my-3 bg-white">
                  <h1 className="text-primary-color font-bold mb-4 ">CASH PAYMENT</h1>
                  <label
                    htmlFor="amount"
                    className="block font-medium text-primary-color"
                  >
          ...
          <div className=" lg:w-1/2 lg:h-5/6 lg:mb-0 mb-5 bg-white shadow-md shadow-dark-gray">
            <h1 className=" bg-primary-color p-2 text-white rounded-tl-md rounded-tr-md">
              ...
              <div className="px-5">
                <h1 className="text-primary-color font-bold text-xl border-b-2 border-dark-gray mb-4 pb-4 ">
                  Php 10,000
                </h1>
                <div>
              ...
              <button className="lg:mt-0  lg:ml-20 lg:mb-8  bg-primary-color text-white w-9/12 ml-12 mb-5 py-3 px-2 rounded-md hover:opacity-80 ">
                Pay
              </button>
              <div className="lg:p-4 flex flex-col p-10 items-center justify-center gap-2 bg-gray">
                <h1 className="text-primary-color font-bold text-lg">Wednesday</h1>
