    ...
    <div className='w-full h-full overflow-y-auto bg-white1'>
      <div className='w-11/12  h-full m-auto'>
        <div className="mx-auto py-8 px-4 text-primary-color p-5 pb-10 mb-10">
          <h1 className="lg:text-3xl text-xl font-bold mb-4">Terms and Conditions for Apartment Management System</h1>
          <div className="prose">
            ...
            <p className="mb-10">These terms and conditions are governed by and construed in accordance with the laws of  Dasmariñas, Cavite ,and you irrevocably submit to the exclusive jurisdiction of the courts in that location.</p>
          </div>
        </div>
      </div>
    </div>
