    ...
    <>
      ...
      <div className="w-full mt-20 px-10 ">
        ...
        <div className="lg:flex lg:w-full lg:flex-row-reverse items-center lg:justify-between mt-8">
          ...
          />
          <p className="lg:hidden text-lg text-dark-gray">Sign in your account</p>
          <form className="lg:w-1/3 lg:ml-20 lg:rounded-md lg:p-5 lg:h-fit lg:bg-white1 lg:shadow-md">
            <h1 className="lg:text-3xl lg:font-bold lg:block text-primary-color hidden">Sign In</h1>
            {error && (
            ...
            <div className="flex flex-col text-primary-color mt-3">
              <label htmlFor="email" className="font-bold">Email / Username</label>
              <input
                type="text"
                name="username"
            ...
            <Link to="forgot-password" className="w-full text-end text-dark-gray font-regular my-3 cursor-pointer">
              Forgot Password?
            </Link>
