...
const TermsAndConditions = () => {
  return (
    <div className="container mx-auto py-8 px-4 text-primary-color">
      <h1 className="text-3xl font-bold mb-4">Terms and Conditions for PinaupaPH</h1>
      <div className="prose">
        ...
        <h2 className="text-xl font-bold mb-2">2. Access to the System</h2>
        ...
        <h2 className="text-xl font-bold mb-2">4. Usage Restrictions</h2>
        ...
        <h2 className="text-xl font-bold mb-2">8. Changes to Terms and Conditions</h2>
