...
const LeaseView = () => {
  return (
    <div className="flex flex-col">
      <p className="pl-5 pt-5 font-bold text-lg">
        DOCUMENTS / LEASE AGREEMENTS
      </p>
      <Dropdown
        title={'Select Action'}
        className="ml-auto mr-6 border border-light-gray rounded-md"
      >
        <Dropdown.Item
      ...
      <div className="flex justify-center align-middle">
        <div className="lg:w-[13.6in] md:w-[8.5in] lg:min-h-[17.6in] md:min-h-[11in] lg:p-[1in] md:p-[0.5in] m-[1rem] shadow-md shadow-light-gray bg-white ">
          <p className="lg:text-4xl md:text-2xl font-bold font-serif text-center lg:mb-12 md:mb-6 ">
            KONTRATA SA PAGPAPAUPA
          </p>
          <p className="font-serif md:text-nowrap lg:mb-12 md:mb-6 lg:text-xl md:text-sm">
            <span className="font-bold">Lokasyon: </span>Blk.L Lot 18 A,
            Butterfly Street. South Garden Homes, Salitran 3, Dasmarines
          </p>
          <p className=" lg:text-xl md:text-sm font-serif lg:mb-2 md:mb-1">
            {' '}
          ...
          <p className="font-serif lg:text-xl md:text-sm ml-[2.5rem] lg:mb-6 md:mb-3">
            1.) Ang upa o renta sa bawat buwan ay nagkakahalaga ng{' '}
            <span className="font-bold">PhP 3,500</span>
          </p>
          <p className="font-serif lg:text-xl md:text-sm ml-[2.5rem] lg:leading-8 md:leading-5">
          ...
          <p className="font-serif lg:text-xl md:text-sm  ml-[5rem] lg:leading-8 md:leading-5">
          ...
          <p className="font-serif lg:text-xl md:text-sm ml-[2.5rem] lg:leading-8 md:leading-5 mt-6">
      ...
      <div className="flex justify-center align-middle">
        <div className="lg:w-[13.6in] md:w-[8.5in] lg:min-h-[17.6in] md:min-h-[11in] p-[1in] m-[1rem] shadow-md shadow-light-gray bg-white ">
          <div className="flex flex-row lg:mx-[2.5rem] md:mx-[1.rem] lg:mt-60 md:mt-40">
          ...
          <div className="flex flex-row lg:mx-[4rem] md:mx-[1rem]">
            <p className="lg:text-xl md:text-sm font-serif text-nowrap">
          ...
          <p className="lg:mt-60 md:mt-40 lg:text-xl md:text-sm font-serif lg:leading-8 md:leading-5">
          ...
          <p className="lg:mt-60 md:mt-40 lg:text-2xl md:text-lg font-bold font-serif">
            Petsa ng simula ng kontrata:
          </p>
          <p className="lg:mt-10 md:mt-5 lg:text-2xl md:text-lg font-bold font-serif">Araw ng bayad:</p>
          <div className="h-60"></div>

          <p className=" lg:text-2xl md:text-lgfont-serif font-bold underline">
            Mga saksi sa kasunduan
          </p>
          <p className="lg:mt-10 md:mt-5 lg:text-2xl md:text-lgfont-serif font-bold underline">1.)</p>
          <p className=" lg:text-2xl md:text-lgfont-serif font-bold underline">2.)</p>
        </div>
      </div>
    </div>
  )
