      ...
      <nav className='w-full h-full'>
        <ul className='w-full m-auto flex flex-col items-center gap-5 mt-5 md:mt-10 text-sm'>
          <li className='w-full h-full '>
            <Link to={'/dashboard'} className={`flex items-center center w-4/5 m-auto h-full hover:bg-primary-color/5 rounded-md ${menu ? 'p-5' : 'p-3'} `}>
              ...
              {menu ? <span className='font-semibold text-primary-color'>Dashboard</span> : ''}
            </Link>
          </li>
          <li className='w-full h-full '>
            <Link to={'/tenant'} className={`flex items-center center w-4/5  m-auto h-full hover:bg-primary-color/5 rounded-md ${menu ? 'p-5' : 'p-3'}`}>
              <figure className={`${menu ? '' : 'flex justify-center'} max-w-10 w-full h-full`}>
                <img src={tenant} alt="" className='max-w-5 max-h-5 object-contain' />
              </figure>
              {menu ? <span className="font-semibold text-primary-color">Tenant</span> : ''}
            </Link>
          </li>
          <li className='w-full h-full'>
            <Link to={'/apartment'} className={`flex items-center center w-4/5  m-auto h-full hover:bg-primary-color/5 rounded-md ${menu ? 'p-5' : 'p-3'}`}>
              <figure className={`${menu ? '' : 'flex justify-center'} max-w-10 w-full h-full`}>
                <img src={apartment} alt="" className='max-w-5 max-h-5 object-contain' />
              </figure>
              {menu ? <span className='font-semibold text-primary-color'>Apartment</span> : ''}
            </Link>
          </li>
          <li className='w-full h-full'>
            <Link to={`/security`} className={`flex items-center center w-4/5  m-auto h-full hover:bg-primary-color/5 rounded-md ${menu ? 'p-5' : 'p-3'}`}>
              <figure className={`${menu ? '' : 'flex justify-center'} max-w-10 w-full h-full`}>
          ...
          <li  className='w-full h-full flex flex-col cursor-pointer'>
            ...
            <div className={`${docs ? '' : 'hidden'} w-full m-auto`}>
                <ul className='flex flex-col'>
                  <li className={`flex items-center center w-4/5  m-auto h-full hover:bg-primary-color/5 rounded-md `}>
