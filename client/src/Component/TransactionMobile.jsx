        ...
        >
          ...
          <div className='flex w-full gap-2 justify-between px-4 items-center'>
            ...
            <div className=''>
              ...
              <div className='font-bold text-sm'>{(val?.amount)?.toLocaleString('en-PH', { style: 'currency', currency: 'PHP' })}</div>
            </div>
          </div>
          <div  onClick={() => handleDownload(val?._id)} className="hover:duration-500 cursor-pointer absolute top-0 right-0 h-full flex items-center justify-center pr-4 text-white opacity-0 transition-opacity  hover:bg-primary-color hover:opacity-100">
