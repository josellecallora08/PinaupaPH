  ...
  return (
    <div>
      <div className="flex h-20 mt-5 items-center rounded-lg mx-4 shadow-md shadow-gray-600">
        <div className={`flex items-center justify-center ${paid?'bg-lime':'bg-red'} rounded-tl-lg rounded-bl-lg h-full w-28 text-center text-xl font-bold p-3  text-white`}>{paid?'Paid':'Unpaid'}</div>
