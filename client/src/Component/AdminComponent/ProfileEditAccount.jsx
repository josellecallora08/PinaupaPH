...
const ProfileEditAccount = ({ isVisible, setIsVisible, setIsProfileEditAccount, user, error, msg }) => {
  ...
  return (
    ...
    <div className='relative'>
      ...
      <form onSubmit={handleSubmit} className="lg:w-full w-[20rem] h-auto px-3 py-4 ">
