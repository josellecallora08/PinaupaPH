...
export const {
  insertAnnouncementNotification,
  fetchAnnouncementStart,
  fetchAnnouncementsSuccess,
  insertAnnouncementSuccess,
...
export const searchAnnouncement = (filter) => async (dispatch) => {
  try {
    ...
    const response = await fetch(
      `${import.meta.env.VITE_URL}/api/announcement/search?filter=${filter}`,
      {
        method: 'GET',
        headers: {
...
export const createAnnouncement = (fields) => async (dispatch) => {
  try {
    ...
    const token = Cookies.get('token')
    const response = await fetch(
      `${import.meta.env.VITE_URL}/api/announcement/`,
      {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
...
export const recentAnnouncement = () => async (dispatch) => {
  try {
    ...
    const token = Cookies.get('token')
    const response = await fetch(
      `${import.meta.env.VITE_URL}/api/announcement/recent`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${token}`,
...
export const fetchAnnouncements = () => async (dispatch) => {
  try {
    ...
    const token = Cookies.get('token')
    const response = await fetch(
      `${import.meta.env.VITE_URL}/api/announcement/list`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${token}`,
...
export const fetchAnnouncement = (announcement_id) => async (dispatch) => {
  try {
    ...
    const token = Cookies.get('token')
    const response = await fetch(
      `${import.meta.env.VITE_URL}/api/announcement/list/v1?announcement_id=${announcement_id}`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${token}`,
...
export const editAnnouncement =
  (fields, announcement_id) => async (dispatch) => {
    try {
      dispatch(fetchAnnouncementStart())
      const token = Cookies.get('token')
      const response = await fetch(
        `${import.meta.env.VITE_URL}/api/announcement/edit?announcement_id=${announcement_id}`,
        {
          method: 'PATCH',
          headers: {
            Authorization: `Bearer ${token}`,
...
export const deleteAnnouncement = (announcement_id) => async (dispatch) => {
  try {
    ...
    const token = Cookies.get('token')
    const response = await fetch(
      `${import.meta.env.VITE_URL}/api/announcement/delete?announcement_id=${announcement_id}`,
      {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${token}`,
